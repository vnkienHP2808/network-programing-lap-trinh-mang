package TopicTCP.TCP_CharacterStream_Kk0twYSQ;
...
/*
 [Mã câu hỏi (qCode): Kk0twYSQ].  Một chương trình server cho phép kết nối qua giao thức TCP tại cổng 2208 (hỗ trợ thời gian giao tiếp tối đa cho mỗi yêu cầu là 5 giây). 
