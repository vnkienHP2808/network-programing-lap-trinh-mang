package TopicTCP.uIsegIUB_TCP_ByteStream;
...
/*
 [Mã câu hỏi (qCode): uIsegIUB].  Một chương trình server hỗ trợ kết nối qua giao thức TCP tại cổng 2206 (hỗ trợ thời gian giao tiếp tối đa cho mỗi yêu cầu là 5s).
